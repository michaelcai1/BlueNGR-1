...
#define configTOTAL_HEAP_SIZE					((size_t)0x3000) /* Not used as heap_5.c is being built, see http://www.freertos.org/a00111.html. */
...
#else
 #define configPRIO_BITS		2	/* cortex-m0 only has three levels */
#endif

/* The lowest interrupt priority that can be used in a call to a "set priority"
function. */
#define configLIBRARY_LOWEST_INTERRUPT_PRIORITY		0
